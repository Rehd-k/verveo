    ...
    <div className="min-h-screen bg-background-dark text-white">
      <div className="grid min-h-screen lg:grid-cols-2">
        ...
        <div className="relative hidden overflow-hidden lg:flex lg:flex-col lg:justify-between">
          ...
          <div className="absolute inset-0 bg-linear-to-br from-background-dark via-[#12151c] to-black" />
          ...
          <div className="relative z-10 flex flex-col gap-10 p-10 xl:p-14">
            <Link
              href="/"
              className="inline-flex w-fit items-center gap-2 text-sm text-text-secondary transition-colors hover:text-white"
            >
            ...
            <div className="space-y-6">
              ...
              <div className="space-y-3">
                ...
                <p className="max-w-md text-sm leading-relaxed text-text-secondary">
                  Launch QR-tracked campaigns on cups, boxes, and bags — then measure every scan in real time.
                </p>
              </div>
            </div>
